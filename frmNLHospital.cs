...
namespace NLHospital
{
	...
	public class frmNLHospital : NLHBase
	{
		...
		private void btnLogin_Click(object sender, System.EventArgs e)
        {
            ...
            DataSet ds_Find = new DataSet();
            Users oUsers = new Users();

            try
            {

                ds_Find = oUsers.FindData(strUser, strPass);
                sMsg = "Welcome " + strUser;
                ...
                switch (strUser)
                {
                    ...
                    case "Admissions":
                        ...
                        break;
                    case "Admin":
                        frmMenu a_menuForm = new frmMenu();
                        a_menuForm.oCurrent.UserName = strUser;
                        a_menuForm.Visible = true;
                        a_menuForm.Activate();
                        a_menuForm.SelectUser();
                        break;
                    case "Nurse":
                        frmMenu n_menuForm = new frmMenu();
                        n_menuForm.oCurrent.UserName = strUser;
                        n_menuForm.Visible = true;
                        n_menuForm.Activate();
                        n_menuForm.SelectUser();
                        break;
                    case "Doctor":
                        frmMenu d_menuForm = new frmMenu();
                        d_menuForm.oCurrent.UserName = strUser;
                        d_menuForm.Visible = true;
                        d_menuForm.Activate();
                        d_menuForm.SelectUser();
                        break;
                }
